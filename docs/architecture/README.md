...
The Harbor flow is split into seven smaller SVGs:
...
Separate learning guide: [How to draw a system architecture from requirements](08-draw-architecture.svg). This guide is not included in the Harbor architecture SVG.
