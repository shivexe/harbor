...
int main(int argc, char **argv) {
    ...
    QTimer::singleShot(300, &window, [&] {
        save(&window, "linux-1.1-empty.png");
        ...
        QTimer::singleShot(100, &window, [&] {
            ...
            save(dialog, "linux-1.1-editor.png");
            ...
            if (!more) result = 1;
                ...
                save(dialog, "linux-1.1-editor-small-more.png");
                scroll->verticalScrollBar()->setValue(scroll->verticalScrollBar()->maximum());
                save(dialog, "linux-1.1-editor-small-more-bottom.png");
                scroll->verticalScrollBar()->setValue(0);
                more->click();
            }
            save(dialog, "linux-1.1-editor-small.png");
            ...
            if (!address || !username || !password || !buttons) { result = 1; dialog->reject(); return; }
        ...
        if (!tree || !tree->currentItem() || !title || title->text() != "example.net" || vault.hosts().size() != 1) result = 1;
        window.resize(1160, 760);
        save(&window, "linux-1.1-host.png");
        ...
        QTimer::singleShot(0, &window, [&] {
            ...
            if (!dialog) { result = 1; return; }
            save(dialog, "linux-1.1-devices.png");
            dialog->reject();
        });
        devices->click();
        QTimer::singleShot(0, &window, [&] {
        ...
        QTimer::singleShot(400, &window, [&, title] {
            ...
            save(dialog, "linux-1.1-pairing.png");
            ...
            options->click();
            save(dialog, "linux-1.1-network-options.png");
            copy->click();
